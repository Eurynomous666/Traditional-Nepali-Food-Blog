  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="box box-info">
        ...
        <div class="box-body">
          <form action="<?php echo base_url();?>fetchdata/addtestimonial" method="POST">
            <div class="form-group">
              <input type="text" class="form-control" name="fullname" placeholder="Name of the Testimonial Giver">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="dowhat" placeholder="What s/he DO?">
            </div>
            <div>
              <textarea class="textarea" placeholder="His/Her Testimonial" name="testimonial" 
                        style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            </div>
            <div class="box-footer clearfix">
              <button type="submit" class="btn btn-default" id="addTestimonial">Add

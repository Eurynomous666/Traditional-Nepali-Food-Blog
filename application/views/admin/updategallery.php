       ...
       <div class="box box-info">
        ...
        <div class="box-body">
          <?php foreach($gallery as $row){ ?>
            <form action="<?php echo base_url();?>fetchdata/updategallery" method="POST">
              <div class="form-group"><input type="hidden" class="form-control" name="gallery_id" value="<?php echo $row->gallery_id; ?>">
                <input type="text" class="form-control" name="name" value="<?php echo $row->caption; ?>">
              </div>

          ...
          <div class="box-body">
            ...
            <ul class="todo-list">
              ...
              <li>
                ...
                <!-- todo text -->
                <span class="text"><?php echo $row->caption;?></span>
                <!-- Emphasis label -->
                <!-- <small class="label label-danger"><i class="fa fa-clock-o"></i> 2 mins</small> -->
                <!-- General tools such as edit or delete-->
                <div class="tools">
                  <a href="<?php echo base_url();?>admin/updategallery/<?php echo $row->gallery_id;?>"><i class="fa fa-edit"></i></a>
                  
                  <a href="<?php echo base_url();?>fetchdata/deletegallery/<?php echo $row->gallery_id;?>" onClick="return (confirm('Sure Want to DELETE?'))"><i class="fa fa-trash-o"></i></a>
                </div>
              </li>
              <?php }?>
            </ul>

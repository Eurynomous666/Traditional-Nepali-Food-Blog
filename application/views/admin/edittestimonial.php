            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                ...
                <li>
                  ...
                  <!-- Emphasis label -->
                  <small class="label label-primary"><?php echo $row->dowhat;?></small>
                  <!-- General tools such as edit or delete-->
                  <div class="tools">
                    <a href="<?php echo base_url();?>admin/updatetestimonial/<?php echo $row->testimonial_id;?>"><i class="fa fa-edit"></i></a>
                    
                    <a href="<?php echo base_url();?>fetchdata/deletetestimonial/<?php echo $row->testimonial_id;?>" onClick="return (confirm('Sure Want to DELETE?'))"><i class="fa fa-trash-o"></i></a>
                  </div>
                </li>
                <?php }?>
              </ul>
